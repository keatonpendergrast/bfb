...
urlfile="https://media.githubusercontent.com/media/keatonpendergrast/bfb/master/2016.csv"
...
```{r}
seven_ok <- filter(seven_clean, INJURY == 0)
seven_injured <- filter(seven_clean, INJURY == 1)

eight_ok <- filter(eight_clean, INJURY == 0)
eight_injured <- filter(eight_clean, INJURY == 1)


nine_injured <- filter(nine_clean, INJURY == 1)
nine_ok <- filter(nine_clean, INJURY == 0)

ten_injured <- filter(ten_clean, INJURY == 1)
ten_ok <- filter(ten_clean, INJURY == 0)

eleven_injured <- filter(eleven_clean, INJURY == 1)
eleven_ok <- filter(eleven_clean, INJURY == 0)

twelve_injured <- filter(twelve_clean, INJURY == 1)
twelve_ok <- filter(twelve_clean, INJURY == 0)

thirteen_injured <- filter(thirteen_clean, INJURY == 1)
thirteen_ok <- filter(thirteen_clean, INJURY == 0)

fourteen_injured <- filter(fourteen_clean, INJURY == 1)
fourteen_ok <- filter(fourteen_clean, INJURY == 0)

fifteen_injured <- filter(fifteen_clean, INJURY == 1)
fifteen_ok <- filter(fifteen_clean, INJURY == 0)

sixteen_injured <- filter(sixteen_clean, INJURY == 1)
sixteen_ok <- filter(sixteen_clean, INJURY == 0)
```

```{r}
plot_str(seven_injured)
```