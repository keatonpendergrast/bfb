...
eleven_injured <- filter(eleven_clean, INJURY == "Yes")
eleven_ok <- filter(eleven_clean, INJURY == "No")

twelve_injured <- filter(twelve_clean, INJURY == "Yes")
twelve_ok <- filter(twelve_clean, INJURY == "No")

thirteen_injured <- filter(thirteen_clean, INJURY == "Yes")
thirteen_ok <- filter(thirteen_clean, INJURY == "No")

fourteen_injured <- filter(fourteen_clean, INJURY == "Yes")
fourteen_ok <- filter(fourteen_clean, INJURY == "No")

fifteen_injured <- filter(fifteen_clean, INJURY == "Yes")
fifteen_ok <- filter(fifteen_clean, INJURY == "No")

sixteen_injured <- filter(sixteen_clean, INJURY == "Yes")
sixteen_ok <- filter(sixteen_clean, INJURY == "No")
```
