...
close0 <- data_2bc %>%
  filter(year == 2006) %>%
  summarise(OXYCODONE = (OXYCODONE/294180154)*100, PROPOXYPHENE = (PROPOXYPHENE/294180154)*100, SUFENTANIL = (SUFENTANIL/294180154)*100, TAPENTADOL = (TAPENTADOL/294180154)*100, OXYMORPHONE = (OXYMORPHONE/294180154)*100, MORPHINE = (MORPHINE/294180154)*100, NALBUPHINE = (NALBUPHINE/294180154)*100, LEVORPHANOL = (LEVORPHANOL/294180154)*100, MEPERIDINE = (MEPERIDINE/294180154)*100, METHADONE = (METHADONE/294180154)*100, DIHYDROCODEINE = (DIHYDROCODEINE/294180154)*100, FENTANYL = (FENTANYL/294180154)*100, HYDROMORPHONE = (HYDROMORPHONE/294180154)*100, OPIUM = (OPIUM/294180154)*100, BUPRENORPHINE = (BUPRENORPHINE/294180154)*100, BUTORPHANOL = (BUTORPHANOL/294180154)*100, CODEINE = (CODEINE/294180154)*100, PENTAZOCINE = (PENTAZOCINE/294180154)*100) %>%
  mutate(year = 2006)
close11 <- data_2bc %>%
  filter(year == 2007) %>%
  summarise(OXYCODONE = (OXYCODONE/296302408)*100, PROPOXYPHENE = (PROPOXYPHENE/296302408)*100, SUFENTANIL = (SUFENTANIL/296302408)*100, TAPENTADOL = (TAPENTADOL/296302408)*100, OXYMORPHONE = (OXYMORPHONE/296302408)*100, MORPHINE = (MORPHINE/296302408)*100, NALBUPHINE = (NALBUPHINE/296302408)*100, LEVORPHANOL = (LEVORPHANOL/296302408)*100, MEPERIDINE = (MEPERIDINE/296302408)*100, METHADONE = (METHADONE/296302408)*100, DIHYDROCODEINE = (DIHYDROCODEINE/296302408)*100, FENTANYL = (FENTANYL/296302408)*100, HYDROMORPHONE = (HYDROMORPHONE/296302408)*100, OPIUM = (OPIUM/296302408)*100, BUPRENORPHINE = (BUPRENORPHINE/296302408)*100, BUTORPHANOL = (BUTORPHANOL/296302408)*100, CODEINE = (CODEINE/296302408)*100, PENTAZOCINE = (PENTAZOCINE/296302408)*100) %>%
  mutate(year = 2007)
close22 <- data_2bc %>%
  filter(year == 2008) %>%
  summarise(OXYCODONE = (OXYCODONE/298688159)*100, PROPOXYPHENE = (PROPOXYPHENE/298688159)*100, SUFENTANIL = (SUFENTANIL/298688159)*100, TAPENTADOL = (TAPENTADOL/298688159)*100, OXYMORPHONE = (OXYMORPHONE/298688159)*100, MORPHINE = (MORPHINE/298688159)*100, NALBUPHINE = (NALBUPHINE/298688159)*100, LEVORPHANOL = (LEVORPHANOL/298688159)*100, MEPERIDINE = (MEPERIDINE/298688159)*100, METHADONE = (METHADONE/298688159)*100, DIHYDROCODEINE = (DIHYDROCODEINE/298688159)*100, FENTANYL = (FENTANYL/298688159)*100, HYDROMORPHONE = (HYDROMORPHONE/298688159)*100, OPIUM = (OPIUM/298688159)*100, BUPRENORPHINE = (BUPRENORPHINE/298688159)*100, BUTORPHANOL = (BUTORPHANOL/298688159)*100, CODEINE = (CODEINE/298688159)*100, PENTAZOCINE = (PENTAZOCINE/298688159)*100) %>%
  mutate(year = 2008)
close33 <- data_2bc %>%
  filter(year == 2009) %>%
    summarise(OXYCODONE = (OXYCODONE/301570342)*100, PROPOXYPHENE = (PROPOXYPHENE/301570342)*100, SUFENTANIL = (SUFENTANIL/301570342)*100, TAPENTADOL = (TAPENTADOL/301570342)*100, OXYMORPHONE = (OXYMORPHONE/301570342)*100, MORPHINE = (MORPHINE/301570342)*100, NALBUPHINE = (NALBUPHINE/301570342)*100, LEVORPHANOL = (LEVORPHANOL/301570342)*100, MEPERIDINE = (MEPERIDINE/301570342)*100, METHADONE = (METHADONE/301570342)*100, DIHYDROCODEINE = (DIHYDROCODEINE/301570342)*100, FENTANYL = (FENTANYL/301570342)*100, HYDROMORPHONE = (HYDROMORPHONE/301570342)*100, OPIUM = (OPIUM/301570342)*100, BUPRENORPHINE = (BUPRENORPHINE/301570342)*100, BUTORPHANOL = (BUTORPHANOL/301570342)*100, CODEINE = (CODEINE/301570342)*100, PENTAZOCINE = (PENTAZOCINE/301570342)*100) %>%
  mutate(year = 2009)
close44 <- data_2bc %>%
  filter(year == 2010) %>%
  summarise(OXYCODONE = (OXYCODONE/303627880)*100, PROPOXYPHENE = (PROPOXYPHENE/303627880)*100, SUFENTANIL = (SUFENTANIL/303627880)*100, TAPENTADOL = (TAPENTADOL/303627880)*100, OXYMORPHONE = (OXYMORPHONE/303627880)*100, MORPHINE = (MORPHINE/303627880)*100, NALBUPHINE = (NALBUPHINE/303627880)*100, LEVORPHANOL = (LEVORPHANOL/303627880)*100, MEPERIDINE = (MEPERIDINE/303627880)*100, METHADONE = (METHADONE/303627880)*100, DIHYDROCODEINE = (DIHYDROCODEINE/303627880)*100, FENTANYL = (FENTANYL/303627880)*100, HYDROMORPHONE = (HYDROMORPHONE/303627880)*100, OPIUM = (OPIUM/303627880)*100, BUPRENORPHINE = (BUPRENORPHINE/303627880)*100, BUTORPHANOL = (BUTORPHANOL/303627880)*100, CODEINE = (CODEINE/303627880)*100, PENTAZOCINE = (PENTAZOCINE/303627880)*100) %>%
  mutate(year = 2010)
close55 <- data_2bc %>%
  filter(year == 2011) %>%
  summarise(OXYCODONE = (OXYCODONE/306378752)*100, PROPOXYPHENE = (PROPOXYPHENE/306378752)*100, SUFENTANIL = (SUFENTANIL/306378752)*100, TAPENTADOL = (TAPENTADOL/306378752)*100, OXYMORPHONE = (OXYMORPHONE/306378752)*100, MORPHINE = (MORPHINE/306378752)*100, NALBUPHINE = (NALBUPHINE/306378752)*100, LEVORPHANOL = (LEVORPHANOL/306378752)*100, MEPERIDINE = (MEPERIDINE/306378752)*100, METHADONE = (METHADONE/306378752)*100, DIHYDROCODEINE = (DIHYDROCODEINE/306378752)*100, FENTANYL = (FENTANYL/306378752)*100, HYDROMORPHONE = (HYDROMORPHONE/306378752)*100, OPIUM = (OPIUM/306378752)*100, BUPRENORPHINE = (BUPRENORPHINE/306378752)*100, BUTORPHANOL = (BUTORPHANOL/306378752)*100, CODEINE = (CODEINE/306378752)*100, PENTAZOCINE = (PENTAZOCINE/306378752)*100) %>%
  mutate(year = 2011)
close66 <- data_2bc %>%
  filter(year == 2012) %>%
