...
MEPERIDINE_BUTORPHANOL2 <- data_8summary12 %>%
  filter(MED == "MEPERIDINE, BUTORPHANOL")

proptest_mbu2 <- pairwise.prop.test(MEPERIDINE_BUTORPHANOL2$yes, MEPERIDINE_BUTORPHANOL2$no)
proptest_mbu2

proptrend_mbu2 <- prop.trend.test(MEPERIDINE_BUTORPHANOL2$yes, MEPERIDINE_BUTORPHANOL2$no)
proptrend_mbu2
```
```
