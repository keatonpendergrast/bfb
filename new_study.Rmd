...
write.csv(data_0summary, file = "data_0summary.csv")
```
...
write.csv(data_2summary2, file = "data_2summary2.csv")
```
...
write.csv(data_8summary2, file = "data_8summary2.csv")
```
...
write.csv(data_6summary, file = "data_6summary.csv")
...
write.csv(data_81summary, file = "data_81summary.csv")

data_81summary2 <- recast(data_81summary, year + variable ~ c("RFV", "year", "MED"), id.var = c("RFV", "year", "MED"))
write.csv(data_81summary2, file = "data_81summary2.csv")

data_81summary2 <- recast(data_81summary, year + variable ~ RFV, id.var = c("RFV", "year"))
write.csv(data_81summary2, file = "data_81summary22.csv")
```
