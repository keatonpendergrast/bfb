...
data_2bc <- data_1 %>%
  ...
  select(-row) %>%
  group_by(year) %>%
  summarise(OXYCODONE = sum(OXYCODONE, na.rm=TRUE), PROPOXYPHENE = sum(PROPOXYPHENE, na.rm=TRUE), SUFENTANIL = sum(SUFENTANIL, na.rm=TRUE), TAPENTADOL = sum(TAPENTADOL, na.rm=TRUE), OXYMORPHONE = sum(OXYMORPHONE, na.rm=TRUE), MORPHINE = sum(MORPHINE, na.rm=TRUE), NALBUPHINE = sum(NALBUPHINE, na.rm=TRUE), LEVORPHANOL = sum(LEVORPHANOL, na.rm=TRUE), MEPERIDINE = sum(MEPERIDINE, na.rm=TRUE), METHADONE = sum(METHADONE, na.rm=TRUE), DIHYDROCODEINE = sum(DIHYDROCODEINE, na.rm=TRUE), FENTANYL = sum(FENTANYL, na.rm=TRUE), HYDROMORPHONE = sum(HYDROMORPHONE, na.rm=TRUE), OPIUM = sum(OPIUM, na.rm=TRUE), BUPRENORPHINE = sum(BUPRENORPHINE, na.rm=TRUE), BUTORPHANOL = sum(BUTORPHANOL, na.rm=TRUE), CODEINE = sum(CODEINE, na.rm=TRUE), PENTAZOCINE = sum(PENTAZOCINE, na.rm=TRUE))

close0 <- data_2bc %>%
  filter(year == 2006) %>%
  summarise(OXYCODONE = (OXYCODONE/20269468)*100, PROPOXYPHENE = (PROPOXYPHENE/20269468)*100, SUFENTANIL = (SUFENTANIL/20269468)*100, TAPENTADOL = (TAPENTADOL/20269468)*100, OXYMORPHONE = (OXYMORPHONE/20269468)*100, MORPHINE = (MORPHINE/20269468)*100, NALBUPHINE = (NALBUPHINE/20269468)*100, LEVORPHANOL = (LEVORPHANOL/20269468)*100, MEPERIDINE = (MEPERIDINE/20269468)*100, METHADONE = (METHADONE/20269468)*100, DIHYDROCODEINE = (DIHYDROCODEINE/20269468)*100, FENTANYL = (FENTANYL/20269468)*100, HYDROMORPHONE = (HYDROMORPHONE/20269468)*100, OPIUM = (OPIUM/20269468)*100, BUPRENORPHINE = (BUPRENORPHINE/20269468)*100, BUTORPHANOL = (BUTORPHANOL/20269468)*100, CODEINE = (CODEINE/20269468)*100, PENTAZOCINE = (PENTAZOCINE/20269468)*100) %>%
  mutate(year = 2006)
close11 <- data_2bc %>%
  filter(year == 2007) %>%
  summarise(OXYCODONE = (OXYCODONE/25459104)*100, PROPOXYPHENE = (PROPOXYPHENE/25459104)*100, SUFENTANIL = (SUFENTANIL/25459104)*100, TAPENTADOL = (TAPENTADOL/25459104)*100, OXYMORPHONE = (OXYMORPHONE/25459104)*100, MORPHINE = (MORPHINE/25459104)*100, NALBUPHINE = (NALBUPHINE/25459104)*100, LEVORPHANOL = (LEVORPHANOL/25459104)*100, MEPERIDINE = (MEPERIDINE/25459104)*100, METHADONE = (METHADONE/25459104)*100, DIHYDROCODEINE = (DIHYDROCODEINE/25459104)*100, FENTANYL = (FENTANYL/25459104)*100, HYDROMORPHONE = (HYDROMORPHONE/25459104)*100, OPIUM = (OPIUM/25459104)*100, BUPRENORPHINE = (BUPRENORPHINE/25459104)*100, BUTORPHANOL = (BUTORPHANOL/25459104)*100, CODEINE = (CODEINE/25459104)*100, PENTAZOCINE = (PENTAZOCINE/25459104)*100) %>%
  mutate(year = 2007)
close22 <- data_2bc %>%
  filter(year == 2008) %>%
  summarise(OXYCODONE = (OXYCODONE/21652844)*100, PROPOXYPHENE = (PROPOXYPHENE/21652844)*100, SUFENTANIL = (SUFENTANIL/21652844)*100, TAPENTADOL = (TAPENTADOL/21652844)*100, OXYMORPHONE = (OXYMORPHONE/21652844)*100, MORPHINE = (MORPHINE/21652844)*100, NALBUPHINE = (NALBUPHINE/21652844)*100, LEVORPHANOL = (LEVORPHANOL/21652844)*100, MEPERIDINE = (MEPERIDINE/21652844)*100, METHADONE = (METHADONE/21652844)*100, DIHYDROCODEINE = (DIHYDROCODEINE/21652844)*100, FENTANYL = (FENTANYL/21652844)*100, HYDROMORPHONE = (HYDROMORPHONE/21652844)*100, OPIUM = (OPIUM/21652844)*100, BUPRENORPHINE = (BUPRENORPHINE/21652844)*100, BUTORPHANOL = (BUTORPHANOL/21652844)*100, CODEINE = (CODEINE/21652844)*100, PENTAZOCINE = (PENTAZOCINE/21652844)*100) %>%
  mutate(year = 2008)
close33 <- data_2bc %>%
  filter(year == 2009) %>%
    summarise(OXYCODONE = (OXYCODONE/29444981)*100, PROPOXYPHENE = (PROPOXYPHENE/29444981)*100, SUFENTANIL = (SUFENTANIL/29444981)*100, TAPENTADOL = (TAPENTADOL/29444981)*100, OXYMORPHONE = (OXYMORPHONE/29444981)*100, MORPHINE = (MORPHINE/29444981)*100, NALBUPHINE = (NALBUPHINE/29444981)*100, LEVORPHANOL = (LEVORPHANOL/29444981)*100, MEPERIDINE = (MEPERIDINE/29444981)*100, METHADONE = (METHADONE/29444981)*100, DIHYDROCODEINE = (DIHYDROCODEINE/29444981)*100, FENTANYL = (FENTANYL/29444981)*100, HYDROMORPHONE = (HYDROMORPHONE/29444981)*100, OPIUM = (OPIUM/29444981)*100, BUPRENORPHINE = (BUPRENORPHINE/29444981)*100, BUTORPHANOL = (BUTORPHANOL/29444981)*100, CODEINE = (CODEINE/29444981)*100, PENTAZOCINE = (PENTAZOCINE/29444981)*100) %>%
  mutate(year = 2009)
close44 <- data_2bc %>%
  filter(year == 2010) %>%
  summarise(OXYCODONE = (OXYCODONE/19796686)*100, PROPOXYPHENE = (PROPOXYPHENE/19796686)*100, SUFENTANIL = (SUFENTANIL/19796686)*100, TAPENTADOL = (TAPENTADOL/19796686)*100, OXYMORPHONE = (OXYMORPHONE/19796686)*100, MORPHINE = (MORPHINE/19796686)*100, NALBUPHINE = (NALBUPHINE/19796686)*100, LEVORPHANOL = (LEVORPHANOL/19796686)*100, MEPERIDINE = (MEPERIDINE/19796686)*100, METHADONE = (METHADONE/19796686)*100, DIHYDROCODEINE = (DIHYDROCODEINE/19796686)*100, FENTANYL = (FENTANYL/19796686)*100, HYDROMORPHONE = (HYDROMORPHONE/19796686)*100, OPIUM = (OPIUM/19796686)*100, BUPRENORPHINE = (BUPRENORPHINE/19796686)*100, BUTORPHANOL = (BUTORPHANOL/19796686)*100, CODEINE = (CODEINE/19796686)*100, PENTAZOCINE = (PENTAZOCINE/19796686)*100) %>%
  mutate(year = 2010)
close55 <- data_2bc %>%
  filter(year == 2011) %>%
  summarise(OXYCODONE = (OXYCODONE/24487463)*100, PROPOXYPHENE = (PROPOXYPHENE/24487463)*100, SUFENTANIL = (SUFENTANIL/24487463)*100, TAPENTADOL = (TAPENTADOL/24487463)*100, OXYMORPHONE = (OXYMORPHONE/24487463)*100, MORPHINE = (MORPHINE/24487463)*100, NALBUPHINE = (NALBUPHINE/24487463)*100, LEVORPHANOL = (LEVORPHANOL/24487463)*100, MEPERIDINE = (MEPERIDINE/24487463)*100, METHADONE = (METHADONE/24487463)*100, DIHYDROCODEINE = (DIHYDROCODEINE/24487463)*100, FENTANYL = (FENTANYL/24487463)*100, HYDROMORPHONE = (HYDROMORPHONE/24487463)*100, OPIUM = (OPIUM/24487463)*100, BUPRENORPHINE = (BUPRENORPHINE/24487463)*100, BUTORPHANOL = (BUTORPHANOL/24487463)*100, CODEINE = (CODEINE/24487463)*100, PENTAZOCINE = (PENTAZOCINE/24487463)*100) %>%
  mutate(year = 2011)
close66 <- data_2bc %>%
  filter(year == 2012) %>%
  summarise(OXYCODONE = (OXYCODONE/308698958)*100, PROPOXYPHENE = (PROPOXYPHENE/308698958)*100, SUFENTANIL = (SUFENTANIL/308698958)*100, TAPENTADOL = (TAPENTADOL/308698958)*100, OXYMORPHONE = (OXYMORPHONE/308698958)*100, MORPHINE = (MORPHINE/308698958)*100, NALBUPHINE = (NALBUPHINE/308698958)*100, LEVORPHANOL = (LEVORPHANOL/308698958)*100, MEPERIDINE = (MEPERIDINE/308698958)*100, METHADONE = (METHADONE/308698958)*100, DIHYDROCODEINE = (DIHYDROCODEINE/308698958)*100, FENTANYL = (FENTANYL/308698958)*100, HYDROMORPHONE = (HYDROMORPHONE/308698958)*100, OPIUM = (OPIUM/308698958)*100, BUPRENORPHINE = (BUPRENORPHINE/308698958)*100, BUTORPHANOL = (BUTORPHANOL/308698958)*100, CODEINE = (CODEINE/308698958)*100, PENTAZOCINE = (PENTAZOCINE/308698958)*100) %>%
  mutate(year = 2012)
close77 <- data_2bc %>%
  filter(year == 2013) %>%
  summarise(OXYCODONE = (OXYCODONE/310929426)*100, PROPOXYPHENE = (PROPOXYPHENE/310929426)*100, SUFENTANIL = (SUFENTANIL/310929426)*100, TAPENTADOL = (TAPENTADOL/310929426)*100, OXYMORPHONE = (OXYMORPHONE/310929426)*100, MORPHINE = (MORPHINE/310929426)*100, NALBUPHINE = (NALBUPHINE/310929426)*100, LEVORPHANOL = (LEVORPHANOL/310929426)*100, MEPERIDINE = (MEPERIDINE/310929426)*100, METHADONE = (METHADONE/310929426)*100, DIHYDROCODEINE = (DIHYDROCODEINE/310929426)*100, FENTANYL = (FENTANYL/310929426)*100, HYDROMORPHONE = (HYDROMORPHONE/310929426)*100, OPIUM = (OPIUM/310929426)*100, BUPRENORPHINE = (BUPRENORPHINE/310929426)*100, BUTORPHANOL = (BUTORPHANOL/310929426)*100, CODEINE = (CODEINE/310929426)*100, PENTAZOCINE = (PENTAZOCINE/310929426)*100) %>%
  mutate(year = 2013)
close88 <- data_2bc %>%
  filter(year == 2014) %>%
  summarise(OXYCODONE = (OXYCODONE/313672860)*100, PROPOXYPHENE = (PROPOXYPHENE/313672860)*100, SUFENTANIL = (SUFENTANIL/313672860)*100, TAPENTADOL = (TAPENTADOL/313672860)*100, OXYMORPHONE = (OXYMORPHONE/313672860)*100, MORPHINE = (MORPHINE/313672860)*100, NALBUPHINE = (NALBUPHINE/313672860)*100, LEVORPHANOL = (LEVORPHANOL/313672860)*100, MEPERIDINE = (MEPERIDINE/313672860)*100, METHADONE = (METHADONE/313672860)*100, DIHYDROCODEINE = (DIHYDROCODEINE/313672860)*100, FENTANYL = (FENTANYL/313672860)*100, HYDROMORPHONE = (HYDROMORPHONE/313672860)*100, OPIUM = (OPIUM/313672860)*100, BUPRENORPHINE = (BUPRENORPHINE/313672860)*100, BUTORPHANOL = (BUTORPHANOL/313672860)*100, CODEINE = (CODEINE/313672860)*100, PENTAZOCINE = (PENTAZOCINE/313672860)*100) %>%
  mutate(year = 2014)
close99 <- data_2bc %>%
  filter(year == 2015) %>%
  summarise(OXYCODONE = (OXYCODONE/316286252)*100, PROPOXYPHENE = (PROPOXYPHENE/316286252)*100, SUFENTANIL = (SUFENTANIL/316286252)*100, TAPENTADOL = (TAPENTADOL/316286252)*100, OXYMORPHONE = (OXYMORPHONE/316286252)*100, MORPHINE = (MORPHINE/316286252)*100, NALBUPHINE = (NALBUPHINE/316286252)*100, LEVORPHANOL = (LEVORPHANOL/316286252)*100, MEPERIDINE = (MEPERIDINE/316286252)*100, METHADONE = (METHADONE/316286252)*100, DIHYDROCODEINE = (DIHYDROCODEINE/316286252)*100, FENTANYL = (FENTANYL/316286252)*100, HYDROMORPHONE = (HYDROMORPHONE/316286252)*100, OPIUM = (OPIUM/316286252)*100, BUPRENORPHINE = (BUPRENORPHINE/316286252)*100, BUTORPHANOL = (BUTORPHANOL/316286252)*100, CODEINE = (CODEINE/316286252)*100, PENTAZOCINE = (PENTAZOCINE/316286252)*100) %>%
  mutate(year = 2015)
close100 <- data_2bc %>%
  filter(year == 2016) %>%
  summarise(OXYCODONE = (OXYCODONE/318015317)*100, PROPOXYPHENE = (PROPOXYPHENE/318015317)*100, SUFENTANIL = (SUFENTANIL/318015317)*100, TAPENTADOL = (TAPENTADOL/318015317)*100, OXYMORPHONE = (OXYMORPHONE/318015317)*100, MORPHINE = (MORPHINE/318015317)*100, NALBUPHINE = (NALBUPHINE/318015317)*100, LEVORPHANOL = (LEVORPHANOL/318015317)*100, MEPERIDINE = (MEPERIDINE/318015317)*100, METHADONE = (METHADONE/318015317)*100, DIHYDROCODEINE = (DIHYDROCODEINE/318015317)*100, FENTANYL = (FENTANYL/318015317)*100, HYDROMORPHONE = (HYDROMORPHONE/318015317)*100, OPIUM = (OPIUM/318015317)*100, BUPRENORPHINE = (BUPRENORPHINE/318015317)*100, BUTORPHANOL = (BUTORPHANOL/318015317)*100, CODEINE = (CODEINE/318015317)*100, PENTAZOCINE = (PENTAZOCINE/318015317)*100) %>%
  mutate(year = 2016)
...
write.csv(data_8summary, file = "mental_rate_bymedcsv")
